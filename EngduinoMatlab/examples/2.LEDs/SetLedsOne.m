%% SetLedsOne.m demo example.
%
% Description:
% This example shows Engduino LEDs 'setLedsone' function call. Function
...
%% Main
% Set individual colours and brightness of the LEDs on Engduino one at a
% time

% Function 'setLedsOne' select one LED in the range [0-15] and colours values between [0-7]. Colours are
