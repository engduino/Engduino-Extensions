%% setLedsExact
% Set the colour for one of the 16 LEDs on Engduino, other LEDs will be turned off
%
%% Syntax
e.setLedsExact(led,colour);
%% Description
% <html>
% <head>
...
%   <tr>
%      <td id="api"><a href="#one">e.setLedsExact(led,colour)</a></td>
...
%
% <html>
% <a name="one" id="title"><li><b>Set the colour of one LED</b></li></a>
% </html>
%
% Connect to Engduino on port 3 and set the Colour of LED_0 to green 
