...
% <br>
% <table style="width: 100%" >
%   <a name="pin_properties"
%   style="text-decoration:none"><h2>Pin Properties</h2></a>
%   <p>Colours are defined in Engduino object e</p>
%   <tr>
%      <td id="api">e.PIN_TYPE_INPUT</td>
%      <td>Set pin as input</td> 
%   </tr>
%   <tr>
%      <td id="api">e.PIN_TYPE_OUTPUT</td>
%      <td>Set pin as output</td> 
%   </tr>
%   <tr>
%      <td id="api">e.PIN_VALUE_HIGH</td>
%      <td>Set pin output HIGH</td> 
%   </tr>
%   <tr>
%      <td id="api">e.PIN_VALUE_LOW</td>
%      <td>Set pin output LOW</td> 
%   </tr>
% </table>
% </html>
%
